...
from app.routers import keywords, posts, publish, schedules, templates, pages, analytics, competitors, naver, seo
...
app.include_router(seo.router, prefix="/api/v1")           # /auth/naver, /posts/naver
